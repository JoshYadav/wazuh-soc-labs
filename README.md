...
Wazuh Suricata Auditd Docker Kali Linux VirusTotal MITRE ATT&CK
...
Any credentials, API keys, tokens, or other secrets used during the labs should be replaced with placeholders before publishing.
